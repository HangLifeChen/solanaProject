...
import { TokenAnchor } from "../target/types/token_factory";
...
describe("Test", () => {
  ...
  const program = anchor.workspace.TokenFactory as Program<HelloAnchor>;
  ...
  // const neb = new web3.PublicKey("DUHySr2PX8qt8HciRNFbeCfMeCjc9CiS3mKzJDMNks53");
  // //2ytSZJhW3xhL7tzfZ6uo2B5WFoDX13ckChnATzpnxzzM
