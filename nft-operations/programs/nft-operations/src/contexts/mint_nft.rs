...
impl<'info> MintNFT<'info> {
    pub fn mint_nft(&mut self, bumps: &MintNFTBumps) -> Result<()> {
        ...
        let metadata_account = CreateMetadataAccountV3Cpi::new(
            ...
            CreateMetadataAccountV3InstructionArgs {
                data: DataV2 {
                    name: "jinbi Test".to_string(),
                    symbol: "GYG".to_string(),
                    uri: "https://gateway.pinata.cloud/ipfs/bafkreibixegilzz3smtuwjwjbamghqx2obrb6ke3zxixiiwm4u5iufqn2m".to_string(),
