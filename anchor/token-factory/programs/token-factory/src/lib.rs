...
declare_id!("3BrWQee3TC7CoG5E4DCCBVH8ZTWcebhU7rNj2xY3LDEW");
const SYSTEM_OWNER: &str = "";
const SYSTEM_PUBKEY: [u8; 32] = [
   26,  82, 195, 170, 211, 103,   5,  13,
   10,  76,  95,   6, 167, 197,  43,  32,
  196,  47, 143,  76,  21,  95, 105,  50,
  190, 162,  65,   6, 193,  19,   3, 227
];
