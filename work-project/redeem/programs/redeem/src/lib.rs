...
declare_id!("8nzKvvpqJXLTxWdodvfZNTDfc8sJoCS8SSXAQT5ggiw5");

const SYSTEM_OWNER: &str			= "8vg67vNGTawTezVMBYiEeW3d931q1fp73FSFLW3CEKu1";
//3333333333333333f64
const NUM_1_DIV_180: f64			= 0.0055555555555555f64;	// 1 / VAULT_RELEASE_DAY
const VAULT_RELEASE_DAY: i64		= 180;	// The number of days for which the Vault Pool is released
const REDEEM_RELEASE_180_SEC: i64	= 180 * 86400;
const REDEEM_RELEASE_90_SEC: i64	= 90 * 86400;
const REDEEM_RELEASE_30_SEC: i64	= 30 * 86400;
