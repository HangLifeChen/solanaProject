...
declare_id!("6EzrCYk1chsxRU1dtAzvH9efuU6Gb474wUNuJ3FSerar");
...
pub struct SolTransfer<'info> {
    ...
    #[account(mut, address = "8vg67vNGTawTezVMBYiEeW3d931q1fp73FSFLW3CEKu1".parse().unwrap())]
    /// CHECK:
...
#[event]
pub struct SolTransferWithFeeEvent {
    pub user: Pubkey,
    pub amount: u64,
    pub timestamp: i64,
    pub fee: u64,
