...
describe("Test", () => {
  // // // 假设你有一个 base58 公钥字符串
  // let pubkey_str = "nVyjcxVWTddPkUF74VbrfByNKyGf2m3Kv4fmyQJNiyi";
  // let pubkey = new PublicKey(pubkey_str);
  // // 如果需要转换为 Uint8Array（等效 [u8; 32]）：
  // let pubkey_bytes = pubkey.toBytes();
  // console.log("Pubkey bytes:", pubkey_bytes);
  ...
  const neb = new web3.PublicKey("7YqptQvgUj2X4kYj73BmciUjdKMySNXzMsWybvQJcrqu");
  //6fNERLqvgThK47sqyAvvujDCRdfmF6gnSipfSA6Dzqbp
  const esNeb = new web3.PublicKey(mintPub.toBase58());
  
  const systemSigner = new web3.PublicKey("nVyjcxVWTddPkUF74VbrfByNKyGf2m3Kv4fmyQJNiyi");
